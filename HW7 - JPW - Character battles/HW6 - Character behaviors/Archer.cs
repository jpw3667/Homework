...
using System.Text;
/*
 * Program name: Archer class
 * Author: Jason Weinberg
 * Purpose: creates an archer with its stats
 * Modifications: 
 */
namespace HW6___Character_behaviors
{
    class Archer : CommonCharacter
    {
        ...
        {
            return "The archer " + base.ToString() + "They also have " + range + " range, and a bonus " + dodge + "% chance to dodge attacks.";
        }
